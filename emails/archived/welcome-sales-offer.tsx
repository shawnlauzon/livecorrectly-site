...
interface WelcomeSalesOfferProps {
  firstName: string;
...
/**
 * ARCHIVED — removed from the welcome series (never converted).
 *
 * Was the old "welcome3" invitation email: one-on-one offer ("Five spots, $50")
 * and Decisions You Can Trust. Kept for reference only; nothing imports this.
 */
export const WelcomeSalesOffer = ({
  firstName,
  chart,
  unsubscribeUrl,
}: WelcomeSalesOfferProps) => {
  return (
    <EmailLayout
...
WelcomeSalesOffer.PreviewProps = {
  firstName: 'Shawn',
  chart: {
    type: 'Generator',
    isGenerator: true,
...
} satisfies WelcomeSalesOfferProps;

export default WelcomeSalesOffer;
